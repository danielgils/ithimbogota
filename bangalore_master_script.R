...
names(io$outcomes)
io$outcomes$mmets
io$outcomes$scenario_pm
io$outcomes$pm_conc_pp
io$outcomes$injuries
io$outcomes$ref_injuries
View(io$outcomes$hb$deaths)
View(io$outcomes$hb$ylls)
View(io$outcomes$pathway_hb$deaths)
View(io$outcomes$pathway_hb$ylls)
io$outcomes$whw$Baseline
io$outcomes$whw$walking
