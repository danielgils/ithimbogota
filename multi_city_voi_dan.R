...
all_inputs <- read.csv('/media/danielgils/Windows/Users/danie/Documents/Daniel Gil/Consultorias/2019/TIGBOG/SourceCode/ITHIM-R/all_city_parameter_inputs.csv',stringsAsFactors = F)
